...
const otherChanges = [
    {
        ...
        icon: "https://wow.zamimg.com/images/wow/icons/medium/spell_nature_lightningshield.jpg",
        text: ["Mana cost reduced by 40%.", "Threat increased by 35%."],
    },
    {
        name: "Rockbiter Weapon",
        icon: "https://wow.zamimg.com/images/wow/icons/medium/spell_nature_rockbiter.jpg",
        text: [
            "Threat increased to 60% (up from 15%).",
            "Elemental Weapons (talent) now also increases the threat generated by Rockbiter Weapon.",
            "Rockbiter Weapon now increases the threat generated from attacks made with the weapon by 10%.",
        ],
    },
    {
        name: "Ancestral Shield",
        text: [
            "Increases your block chance by 60%, and the next block heals you for X amount and consumes the effect. 6-second cooldown.",
        ],
    },
    {
        name: "Static Shock",
        text: [
            "Static Shock is a lightning-based shock spell that taunts the target. Like the other shock spells, this spell has a 6-second cooldown (shared with other shock spells), a 20 yd range, and is affected by the Reverberation talent.",
        ],
    },
    {
        name: "Items",
        text: ["Added Warden T1 and T2 sets."],
    },
];
